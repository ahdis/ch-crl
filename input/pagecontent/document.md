...
* **Examples**: 
   * Use Case 1a: Bundle (document) as [XML](Bundle-BundleUC1aGastro20181201.xml.html) or [JSON](Bundle-BundleUC1aGastro20181201.json.html)
   * Use Case 1b: Bundle (document) as [XML](Bundle-BundleUC1bGastro20181201.xml.html) or [JSON](Bundle-BundleUC1bGastro20181201.json.html)
