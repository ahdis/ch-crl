...
// FIGO
* section[stagingAndGrading].entry[FIGO] only Reference(CHCRLObservationFIGOStaging)
* section[stagingAndGrading].entry[FIGO] ^short = "FIGO"
* section[stagingAndGrading].entry[FIGO].reference 1..
// INRGSS
* section[stagingAndGrading].entry[INRGSS] only Reference(CHCRLObservationINRGSSStaging)
...
// ISS
* section[stagingAndGrading].entry[ISS] only Reference(CHCRLObservationISSStaging)
* section[stagingAndGrading].entry[ISS] ^short = "ISS"
* section[stagingAndGrading].entry[ISS].reference 1..
// Lugano
* section[stagingAndGrading].entry[lugano] only Reference(CHCRLObservationLuganoStaging)
...
// Rai
* section[stagingAndGrading].entry[rai] only Reference(CHCRLObservationRaiStaging)
* section[stagingAndGrading].entry[rai] ^short = "Rai"
* section[stagingAndGrading].entry[rai].reference 1..
// Rhabdomyosarcoma site
* section[stagingAndGrading].entry[rhabdomyosarcomaSite] only Reference(CHCRLObservationRhabdomyosarcomaSiteStaging)
* section[stagingAndGrading].entry[rhabdomyosarcomaSite] ^short = "Rhabdomyosarcoma site"
* section[stagingAndGrading].entry[rhabdomyosarcomaSite].reference 1..
// SIOP
* section[stagingAndGrading].entry[SIOP] only Reference(CHCRLObservationSIOPStaging)
...
* section[stagingAndGrading].entry[torontoTierIIManually] only Reference(CHCRLObservationTorontoTierIIManualStaging)
...
// Elston/Ellis
* section[stagingAndGrading].entry[elstonEllis] only Reference(CHCRLObservationElstonEllisGradingSystem)
* section[stagingAndGrading].entry[elstonEllis] ^short = "Elston/Ellis"
* section[stagingAndGrading].entry[elstonEllis].reference 1..
// Salzer-Kuntschik
* section[stagingAndGrading].entry[salzerKuntschik] only Reference(CHCRLObservationSalzerKuntschikGradingSystem)
