...
* More NKRS variables with profiles, examples and terminology.* 
   ...
   53. Congestive Heart Failure (Variable number: 10.5) ([Profile](http://build.fhir.org/ig/ahdis/ch-crl/StructureDefinition-ch-crl-observation-congestiveheartfailure.html))
   54. Charlson Index (Variable number: 10.14) ([Profile](http://build.fhir.org/ig/ahdis/ch-crl/StructureDefinition-ch-crl-observation-charlsonindex.html))
