...
* More NKRS variables with profiles, examples and terminology.* 
   ...
   53. Diabetes mellitus (Variable number: 10.1) ([Profile](http://build.fhir.org/ig/ahdis/ch-crl/StructureDefinition-ch-crl-observation-diabetesmellitus.html))
   54. Congestive Heart Failure (Variable number: 10.5) ([Profile](http://build.fhir.org/ig/ahdis/ch-crl/StructureDefinition-ch-crl-observation-congestiveheartfailure.html))
   55. Charlson Index (Variable number: 10.14) ([Profile](http://build.fhir.org/ig/ahdis/ch-crl/StructureDefinition-ch-crl-observation-charlsonindex.html))
